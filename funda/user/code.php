...
$pdf_url = 'http://localhost/registrations/GetCollege/funda/user/uploads/' . $pdf_name;
...
// Get the PDF file URL
$pd_url = 'http://localhost/registrations/GetCollege/funda/user/uploads/' . $pd_name;
    // Define the folder where uploaded files will be store
$upload_folder = 'uploads/';
...
// Get the PDF file URL
$p_url = 'http://localhost/registrations/GetCollege/funda/user/uploads/' . $p_name;
    // Define the folder where uploaded files will be store


    $user_query= "INSERT INTO apply_form (name,category,fname,mname,program,course,nation,email,phone,gender,dob,addres,degree,years,percent,stream,deg,yea,perc,str,gname, pdf_url,hname,pd_url,iname,p_url) VALUES ('$name','$category',' $fname','$mname','$program','$course','$nationality','$email','$phone','$gender','$dob','$address','$degree','$year','$percentage','$stream','$degre','$yea','$percentag','$strea','$name', '$pdf_url','$name', '$pd_url','$name', '$p_url')";
